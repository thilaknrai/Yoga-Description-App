...
public class mudre extends AppCompatActivity {
    TextView tv;
    Button p,b,s,up;
    ImageView iv;
    ConstraintLayout l;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mudre);
        ...
        p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i1 = new Intent(mudre.this, gyan.class);
                startActivity(i1);
            }
        });
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i2 = new Intent(mudre.this, shoonya.class);
                startActivity(i2);
            }
        });
        s.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i3 = new Intent(mudre.this, Apaan.class);
                startActivity(i3);
            }
        });
        up.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder ad = new AlertDialog.Builder(mudre.this);
                ad.setTitle("UPGRADE");
                ...
                ad.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent ii= new Intent(mudre.this,pay.class);
                        startActivity(ii);
                    }
                });
