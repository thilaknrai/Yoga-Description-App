...
public class tadasana extends AppCompatActivity {

    TextView padm,padm2,padm3,padm4,padm5,padm6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        padm6=findViewById(R.id.padm7);

        l=findViewById(R.id.l);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
        l.setBackgroundColor(Color.rgb(249,236,236));
        final MediaPlayer mp = MediaPlayer.create(this,R.raw.tadaud);
